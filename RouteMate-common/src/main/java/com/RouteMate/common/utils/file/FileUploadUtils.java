package com.RouteMate.common.utils.file;
...
import com.RouteMate.common.exception.file.FileNameLengthLimitExceededException;
import com.RouteMate.common.exception.file.FileSizeLimitExceededException;
import com.RouteMate.common.exception.file.InvalidExtensionException;
...
import com.RouteMate.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = NaiweilanlanConfig.getProfile();
    ...
    {
        int dirLastIndex = NaiweilanlanConfig.getProfile().length() + 1;
