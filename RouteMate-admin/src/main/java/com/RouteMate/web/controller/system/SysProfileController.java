...
import com.RouteMate.common.utils.file.FileUploadUtils;
import com.RouteMate.common.utils.file.FileUtils;
import com.RouteMate.common.utils.file.MimeTypeUtils;
import com.RouteMate.framework.web.service.TokenService;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(NaiweilanlanConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION, true);
            if (userService.updateUserAvatar(loginUser.getUserId(), avatar))
            {
                String oldAvatar = loginUser.getUser().getAvatar();
                if (StringUtils.isNotEmpty(oldAvatar))
                {
                    FileUtils.deleteFile(NaiweilanlanConfig.getProfile() + FileUtils.stripPrefix(oldAvatar));
                }
