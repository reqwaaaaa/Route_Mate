...
import com.RouteMate.system.service.ISysPostService;
...
public class SysUserController extends BaseController
{
    ...
    public AjaxResult updateAvatar(@PathVariable("userId") Long userId, @RequestBody SysUser user)
    {
        userService.checkUserAllowed(user);
        userService.checkUserDataScope(userId);
        if (StringUtils.isNotEmpty(user.getAvatar()))
        {
            ...
            return toAjax(userService.updateUserAvatar(userId, user.getAvatar()) ? 1 : 0);
        }
